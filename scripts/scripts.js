...
// Seleção de cada caixa de texto do site e qual descrição do documento descricoesCodes eles vão receber, todos em const para garantir que os valores não sejam alterados de acordo com o tempo
$("#htmlBase").val(htmlBase)
